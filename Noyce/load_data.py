...
def load_org_article():

    df = pd.read_csv(
        "./UCD_Noyce/Noyce/data/final_train.csv", encoding='unicode_escape')
    df_test = pd.read_csv(
        "./UCD_Noyce/Noyce/data/final_test.csv", encoding='unicode_escape')
...
def load_ideo_article_filter():

    df = pd.read_csv(
        "./UCD_Noyce/Noyce/data/train_filter.csv", encoding='unicode_escape')
    df_test = pd.read_csv(
        "./UCD_Noyce/Noyce/data/test_filter.csv", encoding='unicode_escape')
...
def load_ideo_article_combined():

    df = pd.read_csv(
        "./UCD_Noyce/Noyce/data/train_combined.csv", encoding='unicode_escape')
    df_test = pd.read_csv(
        "./UCD_Noyce/Noyce/data/test_combined.csv", encoding='unicode_escape')
...
def load_data(dset_name='political_final', path = '', test_set = True):
    ...
    if dset_name == 'ideology_org_article':
        return load_org_article()
    if dset_name == 'ideology_article_filter':
        return load_ideo_article_filter()
    if dset_name == 'ideology_article_combined':
        return load_ideo_article_combined()
