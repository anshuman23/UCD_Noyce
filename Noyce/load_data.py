...
def load_pol_final():
    ...
    df = pd.read_csv(
        "./UCD_Noyce/Noyce/data/POLITICAL/final_version/train.csv", encoding='unicode_escape')
    df_test = pd.read_csv(
        "./UCD_Noyce/Noyce/data/POLITICAL/final_version/test.csv", encoding='unicode_escape')
